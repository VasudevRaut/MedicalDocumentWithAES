package com.example.dfcsproject.Medical;
...
import com.example.dfcsproject.Lab.MentorAdapter;
...
public class Dashboard extends AppCompatActivity {
    ...
    private com.example.dfcsproject.Lab.MentorAdapter pageInfoAdapter;
...
//                        Toast.makeText(Dashboard.this, "3", Toast.LENGTH_SHORT).show();
                        pageInfoAdapter = new com.example.dfcsproject.Lab.MentorAdapter(data_list, Dashboard.this, Dashboard.this);
...
//            String email = sharedPreferences.getString("key_email", "default_value_if_not_found");
            ...
            db.collection("Request")
                    .document(id)
                    .set(new RequestModel(sn,firebaseAuth.getCurrentUser().getEmail(),email,formattedDateTime,user_name,user_bio,"usertomedical"))
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Log.d(TAG, "PDF data successfully written!");
                            Toast.makeText(Dashboard.this, "Uplode Successfuly", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
