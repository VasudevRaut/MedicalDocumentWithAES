...
public class MentorAdapter extends RecyclerView.Adapter<MentorAdapter.LeadData>{
    ...
    public MentorAdapter(List<RequestModel> dataholder2, Context context, Activity activity) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (listener != null) {
                    ...
                    listener.onItemClick(dataholder2.get(position).getUser_email(),dataholder2.get(position).getUser_name(),dataholder2.get(position).getUser_bio());
                }
...
// Apply changes
                ...
                View bottomSheetView = LayoutInflater.from(context)
                        .inflate(
                                R.layout.layout_bottom_sheetdoctorprofile, holder.bottomsheet
                        );
...
//                bio.setText(dataholder2.get(position).getUser_bio());
                ...
                TextView documentview = bottomSheetView.findViewById(R.id.viewDocument);
